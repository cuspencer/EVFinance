...
echo "<DIV class=\"w3-container\">";
echo "<BR/><a href=\"user-admin.php\" class=\"w3-bar-item w3-button admin-menu-item\"><label class=\"material-icons admin-icons\">account_circle</label> Users </a>";
echo "<BR/><a href=\"account-admin.php\" class=\"w3-bar-item w3-button admin-menu-item\"><label class=\"material-icons admin-icons\">account_balance</label> Accounts </a>";
