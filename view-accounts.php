...
$accts_info_stmt = "SELECT accounts.acct_id, accounts.acct_name FROM accounts INNER JOIN acct_user_access ON accounts.acct_id=acct_user_access.acct_id ".
"WHERE accounts.acct_active = 1 AND acct_user_access.user_id = $user_id AND acct_user_access.view = 1";
